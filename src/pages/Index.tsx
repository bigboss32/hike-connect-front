  ...
  return (
    <div className="min-h-screen bg-background pb-28">
      ...
      <div className="relative bg-gradient-to-br from-primary/15 via-background to-accent/10 overflow-hidden">
        ...
        <div className="absolute bottom-0 left-0 right-0 h-12 bg-gradient-to-t from-background via-background/60 to-transparent z-[5]" />
      </div>

      <main className="max-w-lg mx-auto px-4 -mt-4 relative z-10 space-y-5">
